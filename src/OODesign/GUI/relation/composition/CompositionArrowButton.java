...
public class CompositionArrowButton implements ButtonInterface{
	...
	public CompositionArrowButton(JPanel panel0,JFrame frame){
		this.panel0=panel0;
		this.frame=frame;
	}
	/**
	...
	public void setButton(){
		button=new JButton("Composition arrow");
		button.addActionListener(
				new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						JButton b=(JButton)e.getSource();
						MiddlePanel drag=new MiddlePanel(textArea1,panel0,frame,"compositionarrow"); 
