...
public class ImplementArrowButton implements ButtonInterface{
	...
	public ImplementArrowButton(JPanel panel0,JFrame frame){
		this.panel0=panel0;
		this.frame=frame;
	}
	/**
	...
	public void setButton(){
		button=new JButton("implement arrow");
		button.addActionListener(
				new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						JButton b=(JButton)e.getSource();
						MiddlePanel drag=new MiddlePanel(textArea1,panel0,frame,"implementarrow"); 
